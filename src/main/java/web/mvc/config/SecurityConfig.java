        ...
        http.cors((corsCustomizer ->
                corsCustomizer.configurationSource(new CorsConfigurationSource()
                {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                      ...
                      // configuration.setAllowedOrigins(Arrays.asList("http://15.164.218.201", "http://15.164.218.201:80"));
                        configuration.setAllowedOrigins(Arrays.asList("http://kosta.r-e.kr", "https://kosta.r-e.kr"));
